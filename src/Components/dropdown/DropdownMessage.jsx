        ...
        {dropdownOpen && (
          <div className="absolute -right-16 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80">
            ...
            <ul className="flex h-auto flex-col overflow-y-auto">
              {[UserTwo, UserOne, UserThree, UserFour, UserTwo].map(
                (user, index) => (
                  <li key={index}>
                    <Link
                      className="flex gap-5 border-t border-stroke px-5 py-3 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
                      to="/messages"
                    >
